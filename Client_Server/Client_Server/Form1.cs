...
namespace Client_Server
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                var sr = new StreamReader(@"C:\Users\Артур\Desktop\Client_info\data_info.txt");
        ...
        {
            Form2 form = new Client_Server.Form2();
            form.Show();
        }
        ...
        void RecvMessage()
        {
            ...
            for(;;)
            {
                try
                {
                    ...
                    this.Invoke((MethodInvoker)delegate () { richTextBox1.AppendText(Clear_Message); });
                }
                catch(Exception ex) { }
            }
        }
        ...
        {
            MessageBox.Show("(C)ТУСУР, КИБЭВС, Чубаров Артур Николаевич, 745группа, 2017 год", "Автор");
        }
